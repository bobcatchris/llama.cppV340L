...
struct common_params {
    ...
    bool    kv_admission        = true;  // with unified KV, check global cache occupancy before launching a task
    bool    kv_fifo_fill        = true;  // fill slots in FIFO order (oldest task first)
