...
LOG="$LANE/results/amd/coherence/W7_fintail_async_serve.log"
RESP="$LANE/results/amd/coherence/W7_fintail_async_resp.json"
...
export NINFER_VERIFY_LAYER_TRACE=1 NINFER_TP2_TIMING=1 NINFER_TP2_OPTRACE=1
export NINFER_LMHEAD_ARM=simt NINFER_LMHEAD_TRACE=1 NINFER_TILED_TRACE=1
export NINFER_VERIFY_TAIL_TRACE=1 NINFER_PREFILL_OPTRACE=2
export NINFER_MTP_TAIL_ASYNC=1  # W7 finalize-tail cure arm (D2D final column, no sync/D2H)
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_fintail_async_resp.json','w').write(json.dumps(o, indent=1))
