...
LOG="$LANE/results/amd/coherence/W7_graph_serve.log"
RESP="$LANE/results/amd/coherence/W7_graph_resp.json"
...
export NINFER_PREFILL_GRAPH=1  # the capture arm
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_graph_resp.json','w').write(json.dumps(o, indent=1))
