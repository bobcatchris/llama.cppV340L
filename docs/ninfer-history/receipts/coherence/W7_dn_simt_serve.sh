...
LOG="$LANE/results/amd/coherence/W7_dn_simt_serve.log"
RESP="$LANE/results/amd/coherence/W7_dn_simt_resp.json"
...
export NINFER_GDN_SIMT=1  # the leg under test: SIMT dn trio at T=128 chunks=2 (post-DELTA-1/2)
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_dn_simt_resp.json','w').write(json.dumps(o, indent=1))
