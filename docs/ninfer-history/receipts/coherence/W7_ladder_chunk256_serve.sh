...
LOG="$LANE/results/amd/coherence/W7_ladder_chunk256_serve.log"
RESP="$LANE/results/amd/coherence/W7_ladder_chunk256_resp.json"
...
setsid nohup "$BIN" /media/chris/EMTEC256/qwen3_8_27b_nvfp4.ninfer --port $PORT \
  --devices 0,1,2,3 --prefill-chunk 256 --no-prefix-reuse --prefix-cache-capacity 256 \
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_ladder_chunk256_resp.json','w').write(json.dumps(o, indent=1))
