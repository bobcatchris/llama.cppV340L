...
LOG="$LANE/results/amd/coherence/W7_finbracket_serve.log"
RESP="$LANE/results/amd/coherence/W7_finbracket_resp.json"
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_finbracket_resp.json','w').write(json.dumps(o, indent=1))
