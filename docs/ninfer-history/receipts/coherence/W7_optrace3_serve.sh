...
LOG="$LANE/results/amd/coherence/W7_optrace3_serve.log"
RESP="$LANE/results/amd/coherence/W7_optrace3_resp.json"
...
export NINFER_VERIFY_TAIL_TRACE=1 NINFER_PREFILL_OPTRACE=3
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_optrace3_resp.json','w').write(json.dumps(o, indent=1))
