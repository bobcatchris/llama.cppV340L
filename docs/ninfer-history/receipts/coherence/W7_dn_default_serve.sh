...
LOG="$LANE/results/amd/coherence/W7_dn_default_serve.log"
RESP="$LANE/results/amd/coherence/W7_dn_default_resp.json"
...
open('/home/chris/worktrees/amd-wo-w7-body/results/amd/coherence/W7_dn_default_resp.json','w').write(json.dumps(o, indent=1))
